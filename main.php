<?php
  ...
  function pub($stamp) {
    ...
    if ($elapsed_d>=1) {
      echo "Published on ".date_format($datetime2,"D F Y, h:i a");
    }
    elseif ($elapsed_h >0) {
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              ...
              ?>
                   <div class="col-12 col-md pb-5 pb-lg-0">
                     <a class="text-decoration-none" href="mainview.php?kn=<?=$row['news_id']?>">
                       <div class=""><img style="max-height:20rem;" class="img-fluid  pb-2 pt-2" src="news_img/<?=$row['imgname']?>" alt=""></div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              ...
              ?>
                    <div class="col-12 col-md pb-5 pb-lg-0">
                       <a class="text-decoration-none" href="mainview.php?kn=<?=$row['news_id']?>">
                         <div class=""><img style="max-height:20rem;" class="img-fluid  pb-2 pt-2" src="news_img/<?=$row['imgname']?>" alt="">
                         </div>
                         <div class="my-2 text-secondary " style="font-size:1rem;" ><?=pub($row['stamp'])?>
                         </div>
                         <div class="text-dark"><?=$row['Heading']?></div>
